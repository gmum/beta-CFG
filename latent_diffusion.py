...
class StableDiffusion():
    def __init__(self,
                 solver_config: Dict,
                 model_key:str="stable-diffusion-v1-5/stable-diffusion-v1-5",
...
class DDIM_beta(StableDiffusion):
    """
    Basic DDIM solver for SD.
    Useful for text-to-image generation
    """
...
class BaseDDIMGeo(StableDiffusion):
    """
    Basic DDIM solver for SD.
    Useful for text-to-image generation
    """
...
class BetaDDIMGeo(StableDiffusion):
    """
    Basic DDIM solver for SD.
    Useful for text-to-image generation
    """
